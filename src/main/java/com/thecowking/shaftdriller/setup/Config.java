...
public class Config {
    ...
    public static final String SUBCATEGORY_MINERBLOCK = "minerblock";
    ...
    // Miner Block
    public static ForgeConfigSpec.IntValue MINER_BLOCK_MAXPOWER;
    public static ForgeConfigSpec.IntValue MINER_BLOCK_TICKS;
    ...
    static {
        ...
        setupMinerBlockConfig(SERVER_BUILDER, CLIENT_BUILDER);
    ...
    private static void setupFirstBlockConfig(ForgeConfigSpec.Builder SERVER_BUILDER, ForgeConfigSpec.Builder CLIENT_BUILDER) {
        ...
        FIRSTBLOCK_GENERATE = SERVER_BUILDER.comment("Power generation per Coal")
                .defineInRange("generate", 4000, 0, Integer.MAX_VALUE);
    ...
    private static void setupMinerBlockConfig(ForgeConfigSpec.Builder SERVER_BUILDER, ForgeConfigSpec.Builder CLIENT_BUILDER) {
        SERVER_BUILDER.comment("FirstBlock settings").push(SUBCATEGORY_MINERBLOCK);

        MINER_BLOCK_MAXPOWER = SERVER_BUILDER.comment("Maximum power for the Miner")
                .defineInRange("maxPower", 100000, 0, Integer.MAX_VALUE);
        MINER_BLOCK_TICKS = SERVER_BUILDER.comment("Ticks per Operation")
                .defineInRange("ticks", 20, 0, Integer.MAX_VALUE);
        FIRSTBLOCK_SEND = SERVER_BUILDER.comment("Max Power In")
