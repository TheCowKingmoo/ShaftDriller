...
public class JSONUtils {
   ...
   public static long func_226161_m_(JsonObject object, String p_226161_1_) {
      if (object.has(p_226161_1_)) {
         return func_219794_f(object.get(p_226161_1_), p_226161_1_);
      } else {
